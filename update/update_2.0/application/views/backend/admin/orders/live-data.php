                ...
                <div class="card card-outline card-warning">
                    <div class="card-body">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-8">
                                <a href="javascript:void(0)" onclick="confirm_modal('<?php echo site_url('orders/process/' . sanitize($pending['code']) . '/approved'); ?>')" class="btn btn-info btn-block btn-sm text-xs"><?php echo get_phrase('Mark_as_approved'); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
