            ...
            ?>
                <div class="card card-outline card-warning">
                    <div class="card-body">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <a href="<?php echo site_url('orders/details/' . sanitize($approved['code'])); ?>" class="btn btn-warning btn-block btn-sm text-xs"><?php echo get_phrase('details'); ?></a>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
            ...
            ?>
                <div class="card card-outline card-info">
                    <div class="card-body">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <a href="<?php echo site_url('orders/details/' . sanitize($preparing['code'])); ?>" class="btn btn-info btn-block btn-sm text-xs"><?php echo get_phrase('details'); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            ?>
                <div class="card card-outline card-maroon">
                    <div class="card-body">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <a href="<?php echo site_url('orders/details/' . sanitize($prepared['code'])); ?>" class="btn btn-danger bg-maroon btn-block btn-sm text-xs"><?php echo get_phrase('details'); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
