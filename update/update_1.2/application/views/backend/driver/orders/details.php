                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="ordered_items">
                                ...
                                foreach ($ordered_items as $key => $ordered_item) :
                                    $restaurant_details = $this->restaurant_model->get_by_id(sanitize($ordered_item['restaurant_id']));
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="order-detail-menu-title">
                                                <?php echo sanitize(sanitize($menu_details['name'])); ?>
                                            </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="order-detail-menu-quantity float-sm-left">
                                                <?php echo get_phrase('quantity') . ': ' . sanitize(sanitize($ordered_item['quantity'])); ?>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
