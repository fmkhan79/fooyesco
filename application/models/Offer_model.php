...
class Offer_model extends Base_model
{
    ...
    public function isUniquePromoCode($promoCode) {
    ...
    /**
     * GET OFFER CODE BY RESTAURANT ID OR RESTAURANT ID ARRAY
     * GET OFFERS CODE BY RESTAURANT ID ONLY. YOU CAN PROVIDE RESTAURANT ID AS ARRAY [1,3,4,5].
    ...
    // GET TODAYS OFFERS. IT WILL BE DIFFERENT USER WISE
    ...
    /**
     * THIS FUNCTION IS ONLY APPLICABLE FOR CUSTOMERS OFFERS. IT WILL BE CALLED INTERNALLY
     *
     * @return object
     */
    ...
    /**
     * THIS FUNCTION IS ONLY APPLICABLE FOR DRIVERS OFFERS. IT WILL BE CALLED INTERNALLY
     *
     * @return object
     */
    ...
    public function delete_offer($id)
    {
        ...
        if ($this->logged_in_user_role == "owner") {
            ...
            error(get_phrase("you_are_not_authorized"), site_url('offers'));
        }
