...
class Report extends Authorization
{
    ...
    $page_data['placed_from'] = $this->order_model->get_all_orders_for_placed_from($page_data['restaurants']);
    ...
    function details($restaurant_id = null)
    {
        ...
        $page_data['commission_details'] = $this->report_model->get_commission_details($restaurant_id);
        $this->load->view('backend/index', $page_data);
    }
