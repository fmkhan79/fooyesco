...
<section class="detail-wbox mt-4 mb-2">
    <div class="container bg-white text-dark border border-light">
        ...
        <div id="billing-address">
            <h4 class="mt-5 text-dark">Billing & Delivery Address</h4>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="tel" class="form-control" name="phone_mobile" id="inputAddress" required
                            placeholder="Enter mobile..." pattern="/(44)\d{11}$/" title="Please enter valid mobile number followed by 44 with 9 more digits">
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5">
                                            ...
                                            <table class="bill-table">
                                                ...
                                                <tr>
                                                    <td class="bill-type">Service Charges :</td>
                                                    <td class="bill-value"><?php echo currency(sanitize($this->cart_model->get_service_amount())); ?></td>
                                                </tr>
                                                <tr>
