<style>
    ...
    ul.billing-list-topbar li img.billing-active{ display: none;}
    ul.billing-list-topbar li.acitve img.billing-active{ display: block;}
    ul.billing-list-topbar li.acitve img.billing-notactive{ display: none;}
    ul.billing-list-topbar li .img-box{ cursor: pointer;}
    #payment-option,#your-address{ display: none;}
</style>