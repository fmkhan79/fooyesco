...
<div id="buynow" class="featured-btn-wrap text-right">
    <button type="submit" class="btn btn-dark btn-sm pl-5 pr-5 pt-2 pb-2 w-100 rr-btn border-0 mt-2" id="pay-with-stripe-form"><?php echo get_phrase("pay_with_stripe", true); ?></button>
</div>
