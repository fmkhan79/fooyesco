    ...
    <div class="container bg-white text-dark border border-light">
        <!-- <ul class="d-flex justify-content-between align-item-center billing-list-topbar p-0">
            <li class="billing acitve">
                <div class="img-box text-center red">Billig & Delivery <img class="billing-active"
                        src="<?php echo base_url('assets/frontend/default/images/billing-list-icon-acitve.png') ?>" />
                        <img class="billing-notactive"
                        src="<?php echo base_url('assets/frontend/default/images/billing-list-icon.png') ?>" /></div>
            </li>
            <li class="payment">
        ...
        <div id="billing-address">
            <h2 class="mt-5 text-dark text-center">Go for <span class="red">Faster</span> Checkout</h2>

            <form id="billing-form" action="<?php echo base_url("GuestCheckout/createUser");  ?>" method="POST">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="tel" class="form-control" name="phone_mobile" id="inputAddress" required
                            placeholder="Enter mobile..." pattern="^(((\+44\s?\d{4}|\(?0\d{4}\)?)\s?\d{3}\s?\d{3})|((\+44\s?\d{3}|\(?0\d{3}\)?)\s?\d{3}\s?\d{4})|((\+44\s?\d{2}|\(?0\d{2}\)?)\s?\d{4}\s?\d{4}))(\s?\#(\d{4}|\d{3}))?$" title="Please enter valid mobile number followed by 44 with 9 more digits">
                    </div>
                </div>
                <div class="form-row mt-4">
                    <div class="form-group col-md-6">
                        <label for="inputEmail4">First Name *</label>
                        <input type="text" class="form-control" id="" name="first_name" required placeholder="Enter first name...">
                    </div>
                    <div class="form-group col-md-6">
                ...
                <button   type="submit" class="rr-btn border-0 mt-4">Secure Checkout</button>
                </div>
            </form>
        </div>
            ...
            <form id="address-form" onsubmit="submitAddressForm(); return false;">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="zip_code" id="inputAddress" required placeholder="Code">
                    </div>
             ...
             if($discount && $discount > 0){
              ...
              <?php if($discountAmount > 0){ ?>
                                                ...
                                                <?php $grand_total = $this->cart_model->get_grand_total(); ?>
                                                    <input type="hidden" name="grand_total_code"  value="<?php echo sanitize($grand_total); ?>">
                                                    <td class="bill-type" style="width:1px"><?php echo site_phrase('grand_total'); ?> :</td>
                                                    <td class="bill-value font-weight-bold" ><?php echo currency(sanitize($grand_total)); ?></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <div class="featured-btn-wrap text-right">
                                                            <button onclick="window.location.replace('<?php echo site_url('cart'); ?>');" class="btn btn-dark bg-warning btn-sm pl-5 pr-5 pt-2 pb-2 w-100 rr-btn border-0 mt-2"><?php echo site_phrase('back_to_my_cart', true); ?></button>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
