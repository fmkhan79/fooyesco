...
function deleteCookies() {
    ...
    const cookiesToDelete = ['__stripe_mid', '__stripe_sid'];
    
    cookiesToDelete.forEach(function(cookieName) {
        document.cookie = cookieName + '=;expires=Thu, 01 Jan 1970 00:00:00 GMT;path=/';
        // If the cookies have a specific path, set it here
        // document.cookie = cookieName + '=;expires=Thu, 01 Jan 1970 00:00:00 GMT;path=/your_path/';
    });

    // Optionally, you can log or handle any post-deletion logic here
}

// function deleteCiSession() {
//     document.cookie = 'ci_session=;expires=Thu, 01 Jan 1970 00:00:00 GMT;path=/';
//     // If the ci_session cookie has a specific path, set it here
//     // document.cookie = 'ci_session=;expires=Thu, 01 Jan 1970 00:00:00 GMT;path=/your_path/';
// }
