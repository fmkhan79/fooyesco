...
if (count($restaurant_ids) > 0):
    foreach ($restaurant_ids as $restaurant_id):
        ...
        <div class="booking-checkbox_wrap">
            <div class="row">
                <div class="col-sm-8">
                    <h6 class="text-left text-theme-dark">
                    ...
                    <div class="row mb-1">
                        <div class="col-md-1">
                            <img src="<?php echo base_url('uploads/menu/' . sanitize($cart_item['menu_thumbnail'])); ?>"
                                class="cart-page-menu-thumbnail" alt="">
                        </div>
                        <div class=" col-md-4">
                        ...
                        <div class="col-md-2">
                            <div class="cart-page-menu-quantity float-sm-left">
                                <?php echo site_phrase('quantity'); ?> : <span
                                    id="cart-quantity-<?php echo sanitize($cart_item['id']); ?>">
                        ...
                        <div class="col-md-2">
                            <div class="cart-page-menu-sub-total float-sm-right">
                                <?php echo site_phrase('sub_total'); ?> : <span
                                    id="sub-total-<?php echo sanitize($cart_item['id']); ?>">
                        ...
                        <div class="col-md-3">
                            <div class="cart-page-actions float-lg-right">
                                ...
                                <button type="button" class="btn btn-default btn-circle cart-actions"
                                    onclick="confirm_modal('<?php echo site_url('cart/delete/' . sanitize($cart_item['id'])); ?>')"><i
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                <?php if ($this->session->flashdata('confirm_order')): ?>
                    ...
                    <img src="<?php echo base_url('assets/frontend/default/images/tick.png'); ?>" class="img-fluid success-tick"
                ...
                <?php else: ?>
                    <img src="<?php echo base_url('assets/frontend/default/images/empty-cart.png'); ?>" class="img-fluid"
                        alt="<?php echo "empty-cart-logo"; ?>">
                    <span class="d-block mt-2">
                        <?php echo site_phrase('you_got_nothing_to_order'); ?>
                    </span>
                <?php endif; ?>
            </div>
        </div>
