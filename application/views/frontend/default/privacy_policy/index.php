...
<section class="detail-wbox mt-4 mb-2">
    <div class="container bg-white text-dark border border-light">
        ...
        <h1 style="font-size:50px; font-weight:700;" class="mt-5 mb-5 text-dark"><span class="text-privacy">Privacy</span>  <span class="text-policy">Policy</span>
        ...
        <ul style="gap: 10px; display: grid;">
             ...
             <p class="head-1" >Cookies and Tracking Technologies: </p ><p  style="font-weight:500;">  To improve user experience and analyze website traffic.</p>
        ...
        <p class="head-1" ><p style="font-weight:500;"> To comply with legal obligations and prevent fraudulent activity.</p>
        ...
        <p class="head-1" ><p style="font-weight:500;"> To send promotional offers and marketing communications (with your consent).</p>
        <p class="head-1" ><p style="font-weight:500;"> Lodge a complaint with a data protection authority if you believe your rights have been violated.</p>
