<form action="<?php echo site_url('GuestCheckout/pay_with_paypal'); ?>" method="post" id="pay-with-paypal-form" class="payment-form hidden">
    ...
    <button class="payment-option disabled w-100 b-white" type="submit">
      <input type="radio" name="payment" >
      <img src="assets/frontend/default/images/paypal.png" alt="payment">
      <?php echo site_phrase('pay_with_paypal', true); ?>
    </button>
</form>