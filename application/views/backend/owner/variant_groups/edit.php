...
<form action="<?php echo site_url('variation/option/edit'); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="name" name="name" placeholder="<?php echo "E.g : The festive one - medium 11.5"; ?>" value="<?php echo ($menu_options['name']); ?>">
    </div>

    <div class="form-group">
        <label for="price"><?php echo get_phrase("price"); ?><span class="text-danger">*</span></label>
        <input type="text" class="form-control" id="price" name="price" placeholder="<?php echo "E.g : 10,20,30"; ?>" value="<?php echo ($menu_options['price']); ?>">
    </div>
