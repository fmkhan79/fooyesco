    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title"><?php echo get_phrase('customer_addresses', true); ?></h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body p-0">
                        ...
                        <p class="text-muted p-2">
                            ...
                            <?php echo getter(sanitize($customer['address_1']), get_phrase('not_found')); ?>
                        </p>

                        <!-- <div id="mapid2"></div>
                        <p class="text-muted p-2">
                            <strong><i class="fas fa-map-marker-alt mr-1"></i> <?php echo get_phrase('address_2'); ?> : </strong>
                            <?php echo getter(sanitize($customer['address_2']), get_phrase('not_found')); ?>
                        </p>

                        <div id="mapid3"></div>
                        <p class="text-muted p-2">
                            <strong><i class="fas fa-map-marker-alt mr-1"></i> <?php echo get_phrase('address_3'); ?> : </strong>
                            <?php echo getter(sanitize($customer['address_3']), get_phrase('not_found')); ?>
                        </p> -->
                    </div>
                    <!-- /.card-body -->
                </div>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    foreach ($restaurant_ids as $restaurant_id) :
                                                        ...
                                                        if(isset($restaurant_detail) && is_array($restaurant_detail)): ?>
                                                            <a href="<?php echo site_url('site/restaurant/' . rawurlencode(sanitize(isset($restaurant_detail['slug']) ? sanitize($restaurant_detail['slug']) : '')) . '/' . sanitize(isset($restaurant_detail['id']) ? $restaurant_detail['id'] : '')); ?>" class="text-dark" target="_blank"><small class="d-block"> ∙ <?php echo sanitize(isset($restaurant_detail['name']) ? $restaurant_detail['name'] : ''); ?></small></a>
                                                        <?php endif;
                                                    endforeach; ?>
