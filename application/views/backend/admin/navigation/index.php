            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview <?php if ($page_name == "orders/index" && $order_type == "all"  || $order_type == "today" || $order_type == "live" || $page_name == "orders/details") echo 'menu-open'; ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo site_url('orders/live'); ?>" class="nav-link <?php if ($page_name == "orders/index" && $order_type == "live") echo 'active'; ?>">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo site_url('orders/today'); ?>" class="nav-link <?php if ($page_name == "orders/index" && $order_type == "today") echo 'active'; ?>">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo site_url('orders'); ?>" class="nav-link <?php if ($page_name == "orders/index" && $order_type == "all" || $page_name == "orders/details") echo 'active'; ?>">
                ...
                <?php $order_type = isset($order_type) ? $order_type : ""; ?>
                <li class="nav-item has-treeview <?php if ($page_name == "offers/index" && $order_type == "all"  || $order_type == "today" || $order_type == "live" || $page_name == "offers/details") echo 'menu-open'; ?>">
                    <a href="#" class="nav-link <?php if ($page_name == "offers/index" && $order_type == "all"  || $order_type == "today" || $order_type == "live" || $page_name == "offers/details") echo 'active'; ?>">
                        <i class="nav-icon fas fa-hamburger"></i>
                        <p>
                            Offers
                            <i class="fas fa-angle-left right"></i>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo site_url('offers/banner'); ?>" class="nav-link <?php if ( $page_name == "offers/banner") echo 'active'; ?>">
                                <i class="fas fa-calendar-alt nav-icon"></i>
                                <p>Banner Offer</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a href="<?php echo site_url('RefundRequest'); ?>" class="nav-link <?php if ($page_name == "refund_request/index") echo 'active'; ?>">
                        <i class="fas fa-pepper-hot nav-icon"></i>
                        <p>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo site_url('menu'); ?>" class="nav-link <?php if ($page_name == "menu/index" || $page_name == "menu/create" || $page_name == "menu/edit") echo 'active'; ?>">
                                ...
                                <p><?php echo get_phrase("menu", true); ?></p>
                            </a>
                        </li>
                        <li class="nav-item">
