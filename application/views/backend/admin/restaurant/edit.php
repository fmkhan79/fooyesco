                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <label for="cuisine"><?php echo get_phrase("cuisine"); ?></label> <small
                                            class="float-right"><a
                                                href="<?php echo site_url('cuisine/create'); ?>"><?php echo get_phrase("create_new_cuisine"); ?></a></small>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="delivery_charge" class="form-control" name="delivery_charge" placeholder="<?php echo get_delivery_settings('delivery_charge') . ' (' . get_phrase("default") . ') '; ?>" value="<?php echo sanitize($restaurant_data['delivery_charge']); ?>" step=".01">
                                    </div>
                                    <div class="form-group clockpicker">
                                        <label for="maximum_time_to_deliver"><?php echo get_phrase("maximum_time_to_deliver"); ?></label>
                                        <input type="text" class="form-control" id="maximum_time_to_deliver" name="maximum_time_to_deliver" placeholder="<?php echo get_delivery_settings('maximum_time_to_deliver') . ' (' . get_phrase("default") . ') '; ?>" value="<?php echo sanitize($restaurant_data['maximum_time_to_deliver']); ?>">
                                    </div>
                                    <div class="custom-control custom-checkbox mb-3">
                                        <input type="checkbox" class="custom-control-input" name="support_pickup_order" id="support_pickup_order" value="1" <?php if (pickup_order_availability($restaurant_data['id'])) echo "checked"; ?> <?php if (!get_order_settings('pickup_order')) : ?>disabled<?php endif; ?>>
                                        <label class="custom-control-label" for="support_pickup_order">
                                            <?php echo get_phrase('supports_pickup_order'); ?>
                                            <?php if (!get_order_settings('pickup_order')) : ?>
                                                <small><strong class="text-danger">(<?php echo get_phrase('pickup_order_is_disabled_by_admin'); ?>.)</strong></small>
                                            <?php endif; ?>
                                        </label>
                                    </div>
