                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="address_1">
                                <div class="form-group row">
                                    <label for="address_one" class="col-sm-2 col-form-label"><?php echo get_phrase('address_1'); ?><span class='text-danger'>*</span></label>
                                    <div class="col-sm-10">
                                        <input name="address_1" class="form-control" id="address_one" placeholder="<?php echo get_phrase('provide_full_address'); ?>." value="<?php echo sanitize($user_info['address_1']); ?>" />
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="tab-pane" id="address_2">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="address_2" class="form-control" id="address_two" placeholder="<?php echo get_phrase('provide_full_address'); ?>." value="<?php echo sanitize($user_info['address_2']); ?>" />
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="tab-pane" id="address_3">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="address_3" class="form-control" id="address_three" placeholder="<?php echo get_phrase('provide_full_address'); ?>." value="<?php echo sanitize($user_info['address_3']); ?>" />
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="tab-pane" id="finish">
                                <div class="row justify-content-center">
                                    <div class="col text-center">
                                        ...
                                        <button type="submit" class="btn btn-primary mt-5"><?php echo get_phrase('update_customer'); ?></button>
                                    </div>
                                </div>
                                </form>
                            </div>
